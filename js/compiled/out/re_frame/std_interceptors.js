...
var vec__10757_10760 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_10761 = cljs.core.nth.call(null,vec__10757_10760,(0),null);
var only_after_10762 = cljs.core.nth.call(null,vec__10757_10760,(1),null);
var db_changed_QMARK__10763 = (!((only_before_10761 == null))) || (!((only_after_10762 == null)));
if(db_changed_QMARK__10763){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_10761);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_10762);
...
var map__10770 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__10770__$1 = ((((!((map__10770 == null)))?((((map__10770.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10770.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10770):map__10770);
var db = cljs.core.get.call(null,map__10770__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__10770__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__10778 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__10778__$1 = ((((!((map__10778 == null)))?((((map__10778.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10778.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10778):map__10778);
var coeffects = map__10778__$1;
var event = cljs.core.get.call(null,map__10778__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__8679__auto___10781 = arguments.length;
var i__8680__auto___10782 = (0);
while(true){
if((i__8680__auto___10782 < len__8679__auto___10781)){
args__8686__auto__.push((arguments[i__8680__auto___10782]));

var G__10783 = (i__8680__auto___10782 + (1));
i__8680__auto___10782 = G__10783;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__8687__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq10780){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10780));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__7458__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__8686__auto__ = [];
var len__8679__auto___10789 = arguments.length;
var i__8680__auto___10790 = (0);
while(true){
if((i__8680__auto___10790 < len__8679__auto___10789)){
args__8686__auto__.push((arguments[i__8680__auto___10790]));

var G__10791 = (i__8680__auto___10790 + (1));
i__8680__auto___10790 = G__10791;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8687__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__10784_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__10785_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__10785_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq10786){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__10787,G__10788,seq10786__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1537038596904