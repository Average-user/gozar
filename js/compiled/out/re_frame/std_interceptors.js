...
var vec__12008_12011 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_12012 = cljs.core.nth.call(null,vec__12008_12011,(0),null);
var only_after_12013 = cljs.core.nth.call(null,vec__12008_12011,(1),null);
var db_changed_QMARK__12014 = (!((only_before_12012 == null))) || (!((only_after_12013 == null)));
if(db_changed_QMARK__12014){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_12012);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_12013);
...
var map__12021 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__12021__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__12021__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__12029 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__12029__$1 = ((((!((map__12029 == null)))?((((map__12029.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12029.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12029):map__12029);
var coeffects = map__12029__$1;
var event = cljs.core.get.call(null,map__12029__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__8679__auto___12032 = arguments.length;
var i__8680__auto___12033 = (0);
while(true){
if((i__8680__auto___12033 < len__8679__auto___12032)){
args__8686__auto__.push((arguments[i__8680__auto___12033]));

var G__12034 = (i__8680__auto___12033 + (1));
i__8680__auto___12033 = G__12034;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq12031){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12031));
});
...
var args__8686__auto__ = [];
var len__8679__auto___12040 = arguments.length;
var i__8680__auto___12041 = (0);
while(true){
if((i__8680__auto___12041 < len__8679__auto___12040)){
args__8686__auto__.push((arguments[i__8680__auto___12041]));

var G__12042 = (i__8680__auto___12041 + (1));
i__8680__auto___12041 = G__12042;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__12035_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__12036_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__12036_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq12037){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__12038,G__12039,seq12037__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1537411813085