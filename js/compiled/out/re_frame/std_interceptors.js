...
var vec__10707_10710 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_10711 = cljs.core.nth.call(null,vec__10707_10710,(0),null);
var only_after_10712 = cljs.core.nth.call(null,vec__10707_10710,(1),null);
var db_changed_QMARK__10713 = (!((only_before_10711 == null))) || (!((only_after_10712 == null)));
if(db_changed_QMARK__10713){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_10711);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_10712);
...
var map__10720 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__10720__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__10720__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__10728 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__10728__$1;
var event = cljs.core.get.call(null,map__10728__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__8679__auto___10731 = arguments.length;
var i__8680__auto___10732 = (0);
while(true){
if((i__8680__auto___10732 < len__8679__auto___10731)){
args__8686__auto__.push((arguments[i__8680__auto___10732]));

var G__10733 = (i__8680__auto___10732 + (1));
i__8680__auto___10732 = G__10733;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq10730){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10730));
});
...
var args__8686__auto__ = [];
var len__8679__auto___10739 = arguments.length;
var i__8680__auto___10740 = (0);
while(true){
if((i__8680__auto___10740 < len__8679__auto___10739)){
args__8686__auto__.push((arguments[i__8680__auto___10740]));

var G__10741 = (i__8680__auto___10740 + (1));
i__8680__auto___10740 = G__10741;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__10734_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__10735_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__10735_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq10736){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__10737,G__10738,seq10736__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1537053745100