...
var file = cljs.core.get.call(null,map__14960__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14960__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14960__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e14959){var _e = e14959;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6751__auto___14962 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6751__auto___14962)){
var seen_errors_14963 = temp__6751__auto___14962;
if(cljs.core.truth_(seen_errors_14963.has(self))){
} else {
seen_errors_14963.add(self);

var temp__6753__auto___14964 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6753__auto___14964)){
var sense_14965 = temp__6753__auto___14964;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_14965)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1537038607589