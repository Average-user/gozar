...
var file = cljs.core.get.call(null,map__12324__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12324__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12324__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e12323){var _e = e12323;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6751__auto___12326 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6751__auto___12326)){
var seen_errors_12327 = temp__6751__auto___12326;
if(cljs.core.truth_(seen_errors_12327.has(self))){
} else {
seen_errors_12327.add(self);

var temp__6753__auto___12328 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6753__auto___12328)){
var sense_12329 = temp__6753__auto___12328;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12329)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1537053747840