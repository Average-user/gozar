...
var args16209 = [];
var len__8679__auto___16215 = arguments.length;
var i__8680__auto___16216 = (0);
while(true){
if((i__8680__auto___16216 < len__8679__auto___16215)){
args16209.push((arguments[i__8680__auto___16216]));

var G__16217 = (i__8680__auto___16216 + (1));
i__8680__auto___16216 = G__16217;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args16209.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox16212 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox16212 = (function (obj,header,style,tag,meta16213){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox16212.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16214,meta16213__$1){
var self__ = this;
var _16214__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox16212(self__.obj,self__.header,self__.style,self__.tag,meta16213__$1));
});

devtools.toolbox.t_devtools$toolbox16212.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16214){
var self__ = this;
var _16214__$1 = this;
return self__.meta16213;
});

devtools.toolbox.t_devtools$toolbox16212.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox16212.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox16212.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox16212.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox16212.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta16213","meta16213",863151504,null)], null);
});

devtools.toolbox.t_devtools$toolbox16212.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox16212.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox16212";

devtools.toolbox.t_devtools$toolbox16212.cljs$lang$ctorPrWriter = (function (this__8115__auto__,writer__8116__auto__,opt__8117__auto__){
return cljs.core._write.call(null,writer__8116__auto__,"devtools.toolbox/t_devtools$toolbox16212");
});

devtools.toolbox.__GT_t_devtools$toolbox16212 = (function devtools$toolbox$__GT_t_devtools$toolbox16212(obj__$1,header__$1,style__$1,tag__$1,meta16213){
return (new devtools.toolbox.t_devtools$toolbox16212(obj__$1,header__$1,style__$1,tag__$1,meta16213));
});

}

return (new devtools.toolbox.t_devtools$toolbox16212(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1537411822793