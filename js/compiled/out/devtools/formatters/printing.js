...
var len__8679__auto___14411 = arguments.length;
var i__8680__auto___14412 = (0);
while(true){
if((i__8680__auto___14412 < len__8679__auto___14411)){
args__8686__auto__.push((arguments[i__8680__auto___14412]));

var G__14413 = (i__8680__auto___14412 + (1));
i__8680__auto___14412 = G__14413;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8687__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14408){
var G__14409 = cljs.core.first.call(null,seq14408);
var seq14408__$1 = cljs.core.next.call(null,seq14408);
var G__14410 = cljs.core.first.call(null,seq14408__$1);
var seq14408__$2 = cljs.core.next.call(null,seq14408__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__14409,G__14410,seq14408__$2);
});
...
if(cljs.core.truth_((function (){var or__7458__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__8115__auto__,writer__8116__auto__,opt__8117__auto__){
return cljs.core._write.call(null,writer__8116__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__7446__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__7446__auto__){
var or__7458__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__7458__auto__)){
return or__7458__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14414_SHARP_){
return !((cljs.core.meta.call(null,p1__14414_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__14423__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__7458__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e14427){var e__12367__auto__ = e14427;
return false;
}})();
if(cljs.core.truth_(or__7458__auto__)){
return or__7458__auto__;
...
}catch (e14429){var e__12367__auto__ = e14429;
return false;
}}
})())){
...
var _STAR_current_state_STAR_14434 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__14435 = opts;
...
var markup_db = cljs.core.get.call(null,map__14435__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_14434;
}});
...
;
var temp__6751__auto___14440 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6751__auto___14440)){
var managed_print_level_14441 = temp__6751__auto___14440;
var _STAR_print_level_STAR_14439_14442 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_14441;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_14439_14442,managed_print_level_14441,temp__6751__auto___14440,writer,opts,job_fn){
return (function (p1__14437_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__14437_SHARP_,null);
});})(_STAR_print_level_STAR_14439_14442,managed_print_level_14441,temp__6751__auto___14440,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_14439_14442;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1537053753011