...
var G__15696 = devtools.prefs.pref.call(null,v);
v = G__15696;
continue;
} else {
return v;
...
var and__7446__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__7446__auto__){
var and__7446__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__7458__auto__ = (function (){try{if(!((value == null))){
...
}catch (e15709){var e__13693__auto__ = e15709;
return false;
}})();
if(cljs.core.truth_(or__7458__auto__)){
return or__7458__auto__;
} else {
var or__7458__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e15713){var e__13693__auto__ = e15713;
return false;
}})();
...
}catch (e15715){var e__13693__auto__ = e15715;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__7446__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7446__auto__)){
var and__7446__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__7446__auto____$1){
...
var and__7446__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__7446__auto__)){
...
var or__7458__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__7458__auto__)){
return or__7458__auto__;
} else {
...
var and__7446__auto__ = (function (){var or__7458__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__7458__auto__)){
return or__7458__auto__;
} else {
...
var vec__15720 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15720,(0),null);
var name = cljs.core.nth.call(null,vec__15720,(1),null);
...
var and__7446__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__7446__auto__)){
...
var or__7458__auto__ = typeof value === 'string';
if(or__7458__auto__){
return or__7458__auto__;
} else {
var or__7458__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__15723_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15723_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1537411821263