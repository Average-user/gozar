...
var G__14370 = devtools.prefs.pref.call(null,v);
v = G__14370;
continue;
} else {
return v;
...
}catch (e14383){var e__12367__auto__ = e14383;
return false;
}})();
...
}catch (e14387){var e__12367__auto__ = e14387;
return false;
}})();
...
}catch (e14389){var e__12367__auto__ = e14389;
return false;
}}
}
});
...
var vec__14394 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__14394,(0),null);
var name = cljs.core.nth.call(null,vec__14394,(1),null);
...
return cljs.core.some.call(null,(function (p1__14397_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14397_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1537053752814